...
<script type="text/javascript">
    function getDiscount(jumlahBuku) {
        if(jumlahBuku > 10) {
            var discount = jumlahBuku * 500 * 0.1;
        } else {
            var discount = 0;
        }
    ...
    function getBayar(jumlahBuku) {
        var discount = getDiscount(jumlahBuku);

        if (discount > 0) {
            var totBay = jumlahBuku * 500 - discount;
        } else {
            var totBay = jumlahBuku * 500;
        }

        return totBay;
    }

    function getGaji(pend) {
        switch(pend) {
            case 1:
