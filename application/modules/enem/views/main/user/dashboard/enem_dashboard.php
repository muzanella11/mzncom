<style type="text/css">
	...
	.list-data-action li:last-child {
		margin-right: 0px;
	}
	.enem.wrapper-loading-panel {
		text-align: center;
    	font-size: 50pt;
    	display: none;
	}
...
<section id="main-content">
	<section class="wrapper">
			...
			<div class="row state-overview">
				...
				<div class="col-lg-3 col-sm-6">
					<section class="panel">
						...
						<div class="value">
							<h1 class="enem-count notification">
								0
							</h1>
							<p>
								Notification
		...
		<!-- Begin Table Role and Log Status -->

			<!-- page start-->
			<div class="row">
				<div class="col-lg-6">
					<section class="panel <?php echo $paginationRole; ?>">
						<header class="panel-heading">
							Data Enem Role
						</header>
						<div class="panel-body">
							<div class="col-lg-12 enem no-padding">
								<button data-enem="enemModalDynamic" data-modal-id="modalAddRole" class="enem btn btn-blue enem-waves">
									<i class="icon-plus"></i> Add new role
								</button>
						    <div class="adv-table table-responsive" pagination-name="<?php echo $paginationRole; ?>">
						    	<div class="enem wrapper-loading-panel">
						    		<span class="icon-spin icon-spinner"></span>
						    	</div>
						    	<div class="enem wrapper-content content-pagination">
						    		<?php echo $this->load->view('main/user/dashboard/partials/tbl_role'); ?>
						    	</div>
						    </div>
						</div>
					</section>
				...
				<div class="col-lg-6">
					<section class="panel <?php echo $paginationTypeLog; ?>">
						<header class="panel-heading">
							Data Enem Type Log
						</header>
						<div class="panel-body">
							<div class="col-lg-12 enem no-padding">
								<button data-enem="enemModalDynamic" data-modal-id="modalAddLog" class="enem btn btn-blue enem-waves">
									<i class="icon-plus"></i> Add new log
								</button>
						    <div class="adv-table table-responsive" pagination-name="<?php echo $paginationTypeLog; ?>">
						    	<div class="enem wrapper-loading-panel">
						    		<span class="icon-spin icon-spinner"></span>
						    	</div>
						    	<div class="enem wrapper-content content-pagination">
						    		<?php echo $this->load->view('main/user/dashboard/partials/tbl_type_log'); ?>
						    	</div>
						    </div>
						</div>
					</section>
		...
		<!-- Begin Table User -->
			...
			<div class="row">
				<div class="col-lg-12">
					<section class="panel <?php echo $paginationUser; ?>">
						<header class="panel-heading">
							Data Enem User
						</header>
						<div class="panel-body">
							<div class="col-lg-12 enem no-padding">
								<button data-enem="enemModalDynamic" data-modal-id="modalAddUser" class="enem btn btn-blue enem-waves">
									<i class="icon-plus"></i> Add new user
								</button>
						    <div class="adv-table table-responsive" pagination-name="<?php echo $paginationUser; ?>">
						    	<div class="enem wrapper-loading-panel">
						    		<span class="icon-spin icon-spinner"></span>
						    	</div>
						    	<div class="enem wrapper-content content-pagination">
						    		<?php echo $this->load->view('main/user/dashboard/partials/tbl_user'); ?>
						    	</div>
						    </div>
						</div>
					</section>
			...
			<div class="row">
				<div class="col-lg-12">
					<section class="panel">
						...
						<div class="panel-body">
							<div class="col-lg-12 enem no-padding">
								<button class="enem btn btn-blue enem-waves formdata">
									<i class="icon-plus"></i> Show Content
								</button>
								<div class="col-lg-12 enem no-padding formDataContent">
									<form enctype="multipart/form-data" id="myformData">
					...
					<script type="text/javascript">
						...
						// formData.append('imagetitle', $('input[name="imagetitle"]').val());
						// formData.append('anu', 'asdasd');
						// formData.append('data', data);
						// formData.append('file', $('#image_file')[0].files[0]);
						// console.info($('#imagetitle')[0]);
						$('#myformData').submit(function(e){
					    	e.preventDefault(); 
					    	// console.info($('#image_file')[0].files[0]);
					        $.ajax({
					            url: enem.powerGetUrl() + 'enem/ajax/upload',
								type:"post",
